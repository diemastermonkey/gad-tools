...
2. Locates the game in the 'meta data' file '**gad-scummvm-deploy.csv**', prepared from [ScummVM Compatibility List](https://www.scummvm.org/compatibility/). If there are multiple matches, it prompts the user to select.
